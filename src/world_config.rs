    ...
    StaticWorld {
        blocks: vec![
            WorldBlock {
                ...
                surface: vec![Surface {
                    positive: Range::Range(dirt_start_patch, dirt_stop_patch),
                    ..default()
                }],
            },
            WorldBlock {
                ...
                surface: vec![Surface {
                    positive: Range::Range(grass_start_patch, grass_stop_patch),
                    negative: Range::Range(grass_start_neg, grass_stop_neg),
                }],
            },
            WorldBlock {
                objects: vec![Model {
